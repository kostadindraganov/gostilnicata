		...
		<main class="p-5 my-5">
			<div class="text-center md:my-12 sm:my-8">
				...
				<div class="text-dark-200 text-md my-4 px-3">
					<span>Доставката е от понеделник до петък, от 10:00 до 17:00 ч. </span>
					<p>В рамките на града под 5,11 €. Доставка <b>1,53 €.</b></p>
					<p>
						Приети поръчки до 11:00 часа се изпълняват до 12:00 часа.След 11:00 часа се изпълняват до 13:00 часа.
					</p>
				</div>
			</div>
